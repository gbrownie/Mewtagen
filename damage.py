...
class Damage:
    ...
    def read_damage_cache():
        ...
        if tentative_cache is None:
            ...
            print("Damage took", time.perf_counter() - tick)
    ...
    def read_move_cache():
        ...
        if tentative_cache is None:
            ...
            print("Moves took", time.perf_counter() - tick)
    ...
    def read_switch_cache():
        ...
        if tentative_cache is None:
            ...
            print("Switches took", time.perf_counter() - tick)
    ...
    def get_mutations():
        ...
        if tentative_mutations is None:
            ...
            print("Mutations took", time.perf_counter() - tick)
        else:
